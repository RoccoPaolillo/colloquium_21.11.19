...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <go>repeat 50 [go]</go>
    <timeLimit steps="40"/>
    <exitCondition>v_sqr &gt; e_sqr or e_crl &gt; v_crl</exitCondition>
    <metric>ticks</metric>
    ...
    <metric>mean [ethnic-utility] of turtles with [count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean [value-utility] of turtles with [count (turtles-on neighbors) &gt;= 1]</metric>
    ...
    <metric>mean [ethnic-utility] of turtles with [count (turtles-on neighbors) &gt;= 1  and ethnicity = "local" and shape = "square"]</metric>
    <metric>mean [value-utility] of turtles with [count (turtles-on neighbors) &gt;= 1 and ethnicity = "local" and shape = "square"]</metric>
    ...
    <metric>mean [ethnic-utility] of turtles with [count (turtles-on neighbors) &gt;= 1  and ethnicity = "local" and shape = "circle"]</metric>
    <metric>mean [value-utility] of turtles with [count (turtles-on neighbors) &gt;= 1 and ethnicity = "local" and shape = "circle"]</metric>
    ...
    <metric>mean [ethnic-utility] of turtles with [count (turtles-on neighbors) &gt;= 1 and ethnicity = "minority"  and shape = "square"]</metric>
    <metric>mean [value-utility] of turtles with [count (turtles-on neighbors) &gt;= 1 and ethnicity = "minority"  and shape = "square"]</metric>
    ...
    <metric>mean [ethnic-utility] of turtles with [count (turtles-on neighbors) &gt;= 1 and ethnicity = "minority"  and shape = "circle"]</metric>
    <metric>mean [value-utility] of turtles with [count (turtles-on neighbors) &gt;= 1 and ethnicity = "minority"  and shape = "circle"]</metric>
    ...
    <steppedValueSet variable="e_sqr" first="0" step="1" last="10"/>
    <steppedValueSet variable="v_sqr" first="0" step="1" last="10"/>
    <steppedValueSet variable="v_crl" first="0" step="1" last="10"/>
    <steppedValueSet variable="e_crl" first="0" step="1" last="10"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
